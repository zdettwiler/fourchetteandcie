...
@section('content')
	...
	<a href="http://www.fourchetteandcie.com/checkout/{{ $order->order_token}}/shipping/confirm/placed/payment" style="display: block; margin: auto; width: 70%; color: #FFFFFF; text-align: center; font-size: 18px; font-family: Arial, sans-serif; text-decoration: none; padding: 15px 0; background-color: #7cffb1; border-radius: 7px;">SEE THE ORDER</a>
